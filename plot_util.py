...
def plot_3d(ground_truth, generated, filename='scatter_plot_3d_highlighted_overlap.png'):
    ...
    ax.scatter(ground_truth[:, 0], ground_truth[:, 1], ground_truth[:, 2],
               label='Ground-Truth', alpha=0.1, s=5, color='blue', marker='o')

    # Plot generated points
    ax.scatter(generated[:, 0], generated[:, 1], generated[:, 2],
               label='Generated', alpha=0.3, s=8, color='red', marker='o')
...
def plot_3d_subplots(ground_truth, generated, filename='scatter_subplot_3d_highlighted_overlap_subplots.png'):
    ...
    ax1.scatter(ground_truth[:, 0], ground_truth[:, 1], ground_truth[:, 2],
                label='Ground-Truth', alpha=0.1, s=5, color='blue', marker='o')
    if overlaps.size > 0:
        ax1.scatter(overlaps[:, 0], overlaps[:, 1], overlaps[:, 2],
                    label='Overlapping Points', alpha=1.0, s=30, color='yellow', edgecolor='black', marker='o')
    else:
        ax1.scatter([], [], [], label='Overlapping Points', alpha=1.0, s=30, color='yellow', edgecolor='black', marker='o')
    ...
    ax2.scatter(generated[:, 0], generated[:, 1], generated[:, 2],
                label='Generated', alpha=0.3, s=8, color='red', marker='o')
    if overlaps.size > 0:
        ax2.scatter(overlaps[:, 0], overlaps[:, 1], overlaps[:, 2],
                    label='Overlapping Points', alpha=1.0, s=30, color='yellow', edgecolor='black', marker='o')
    else:
        ax2.scatter([], [], [], label='Overlapping Points', alpha=1.0, s=30, color='yellow', edgecolor='black', marker='o')
